...
// ============================================
// REFLECTION TOKEN FACTORY
// ============================================

export const REFLECTION_FACTORY_ADDRESS = (process.env.NEXT_PUBLIC_REFLECTION_FACTORY_ADDRESS || '0x0000000000000000000000000000000000000000') as `0x${string}`;

export const REFLECTION_FACTORY_ABI = [
  {
    inputs: [{ internalType: 'address', name: '_feeRecipient', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'constructor',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'string', name: 'symbol', type: 'string' },
      { internalType: 'uint256', name: 'totalSupply', type: 'uint256' },
      { internalType: 'address[2]', name: 'wallets', type: 'address[2]' },
      { internalType: 'uint256[5]', name: 'buyTaxes', type: 'uint256[5]' },
      { internalType: 'uint256[5]', name: 'sellTaxes', type: 'uint256[5]' },
    ],
    name: 'createTokenWithTaxes',
    outputs: [{ internalType: 'address', name: 'tokenAddress', type: 'address' }],
    stateMutability: 'payable',
    type: 'function',
  },
...
// ============================================
// REFLECTION TOKEN ABI
// ============================================

export const REFLECTION_TOKEN_ABI = [
  {
    inputs: [],
    name: 'name',
    outputs: [{ internalType: 'string', name: '', type: 'string' }],
  ...
  {
    inputs: [],
    name: 'getExcludedFromReflectionCount',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    name: 'getExcludedFromReflection',
    outputs: [{ internalType: 'address', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  // Management functions
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_liquidity', type: 'uint256' },
      { internalType: 'uint256', name: '_burn', type: 'uint256' },
      { internalType: 'uint256', name: '_reflection', type: 'uint256' },
    ],
    name: 'setBuyTaxes',
    outputs: [],
    stateMutability: 'nonpayable',
